    ...
    return (
        <div className='mt-8 px-16 py-4 flex items-center justify-between'>
            <div className='flex flex-wrap gap-4 items-center'>
                <Select>
                    <SelectTrigger
                        className='shadow-sm w-[180px] text-gray-500 font-bold border-none bg-white rounded-lg
          ...
          focus:ring-2 focus:ring-gray-200'
                ...
                <div className='relative'>
                    ...
                    <Input
                        type='number'
                        placeholder='Weight'
                        className='shadow-sm w-[180px] pl-9 text-gray-500 font-bold border-none outline-none bg-white rounded-lg
            ...
            <Button className='shadow-sm font-bold bg-purple rounded-lg flex items-center gap-1'>
