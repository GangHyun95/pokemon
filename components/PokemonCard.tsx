...
import { PokemonDetail, PokemonType } from '@/context/usePokemonData';
        ...
        <div className='relative p-4 bg-white rounded-xl shadow-sm flex flex-col gap-2'>
            <div className='flex justify-between items-center'>
                <div className='flex gap-4 bg-white rounded-tl-xl rounded-tr-xl'>
                    <button
                        className={`p-2 w-10 h-10 text-xl text-gray-300 flex items-center justify-center rounded-full border-2`}
                    >
                        {heartEmpty}
                    </button>
                    <button
